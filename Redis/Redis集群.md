...
# 个人疑惑，当达到2个哨兵确定7001挂了就确定为7001真的挂了，但是就是哨兵之间是如何通信的，怎么知道其他哨兵也知道7001挂了？还是说在7001挂之前，就已经通过监控7001，7001将监控它的所有哨兵发给每一个哨兵？
```
...
# 开启集群功能
cluster-enabled yes
# 集群的配置文件名称，只需要我们指定文件名即可，该文件由redis自己维护，是只读文件.
...
# 创建集群,根据replicas计算出，前三个为主，后三个为对应的从...
